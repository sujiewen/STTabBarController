...
- (id)initWithFrame:(CGRect)frame {
    CGFloat height = ([UIDevice currentDevice].systemVersion.floatValue >= 7) ? 64 : 44;
...
- (void)setFrame:(CGRect)frame {
    ...
    self.separatorView.frame = CGRectMake(0, CGRectGetHeight(self.bounds) - (1.0 / [UIScreen mainScreen].scale), CGRectGetWidth(self.bounds), (1.0 / [UIScreen mainScreen].scale));
